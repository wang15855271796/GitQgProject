 ...
 */
public class SearchInnerAdapter extends BaseQuickAdapter<SearchResultsModel.DataBean.RecommendProdBean.ProdPricesBean,BaseViewHolder>{
    ...
    int businessType;
    public SearchInnerAdapter(int businessType,int productId,int layoutResId, @Nullable List<SearchResultsModel.DataBean.RecommendProdBean.ProdPricesBean> data) {
    ...
    @Override
    protected void convert(BaseViewHolder helper, SearchResultsModel.DataBean.RecommendProdBean.ProdPricesBean item) {
